/*
Thằng nào lấy đéo ghi nguồn làm chó
Code của icecnguyen
https://bio.icêcnguyen.dpdns.org
*/
...
- (void)initDisplayLabel {
    ...
    self.displayLabel.font = [UIFont systemFontOfSize:10 weight:UIFontWeightBold];
    self.displayLabel.adjustsFontSizeToFitWidth = YES;
    self.displayLabel.minimumScaleFactor = 0.5;
...
- (void)updateDisplayLabelText:(float)fps {
    ...
    NSString *WMText = [NSString stringWithFormat:@"FPS: %d | Pin: %.0f%% | %@ | icecnguyen",
